        ...
        <div style={styles.addBarContainer}>
                                    ...
                                    <TableRow key={exp}>
                                        <TableCell
                                            onClick={() => {
                                                ...
                                                const updatedTrade = { ...newTrade, expiration_date: exp, instrument: '', strike_price: '', type: 'Call', price: '', iv_percent: '', delta: '', gamma: '', theta: '', vega: '' };
            ...
            <div style={{ display: 'flex', gap: '10px', width: '100%' }}>
                <div style={{ ...styles.inputContainer, flex: 1 }}>
                    <span style={styles.inputLabel}>Option Side</span>
                    <button
                        onClick={() => {
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{ color: '#aaa', fontSize: 'clamp(0.45rem,0.56vw,0.55rem)' }}>
                        Delta
                    </span>
                    <span style={{ color: 'white', fontSize: 'clamp(0.6rem,0.8vw,0.7rem)' }}>
                        {formatGreek(newTrade.delta)}
                    </span>
                </div>
                <div style={{
                    display: 'flex',
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{ color: 'white', fontSize: 'clamp(0.6rem,0.8vw,0.7rem)' }}>
                        {parseFloat(newTrade.price).toFixed(2) || '—'}
                    </span>
                </div>
                <div style={{
                    display: 'flex',
                    ...
                    <span style={{ color: 'white', fontSize: 'clamp(0.6rem,0.8vw,0.7rem)' }}>
                        {newTrade.iv_percent ? newTrade.iv_percent + '%' : '—'}
                    </span>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <span style={{ color: 'white', fontSize: 'clamp(0.6rem,0.8vw,0.7rem)' }}>
                    {parseFloat(newTrade.size) && parseFloat(newTrade.price) ? (parseFloat(newTrade.size) * parseFloat(newTrade.price)).toFixed(2) : '—'} USD
                    </span>
                </div>
            </div>
